...
export default async function CategoriesPage() {
  ...
  const productCategories = Array.from(new Set(products.map((p: { category: string }) => p.category))) as string[];
  const serviceCategories = Array.from(new Set(services.map((s: { category: string }) => s.category))) as string[];
